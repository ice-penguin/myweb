...
// document.writeln('onclick="javascript:$(\'#divFloatToolsView\').animate({width: \'show\', opacity: \'show\'}, \'normal\',function(){ $(\'#divFloatToolsView\').show();kf_setCookie(\'RightFloatShown\', 0, \'\', \'/\', \'www.myya.cc\'); });$(\'#aFloatTools_Show\').attr(\'style\',\'display:none\');$(\'#aFloatTools_Hide\').attr(\'style\',\'display:block\');"');
// document.writeln('href="javascript:void(0);">展开</A> <A id=aFloatTools_Hide class=btnCtn');
// document.writeln('title=关闭在线客服');
// document.writeln('onclick="javascript:$(\'#divFloatToolsView\').animate({width: \'hide\', opacity: \'hide\'}, \'normal\',function(){ $(\'#divFloatToolsView\').hide();kf_setCookie(\'RightFloatShown\', 1, \'\', \'/\', \'www.myya.cc\'); });$(\'#aFloatTools_Show\').attr(\'style\',\'display:block\');$(\'#aFloatTools_Hide\').attr(\'style\',\'display:none\');"');
...
// document.writeln('          <H3 class=titZx>在线咨询</H3>');
// document.writeln('        </LI>');
// document.writeln('        <LI><A target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2449318994&site=qq&menu=yes">售前咨询</A> </LI>');
// document.writeln('        <LI><A target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2449318994&site=qq&menu=yes">售后客服</A> </LI>');
// document.writeln('      </UL>');
// document.writeln('');
// document.writeln('      <UL>');
// document.writeln('        <LI>');
// document.writeln('          <H3 class=titDh>微信扫一扫</H3>');
// document.writeln('        </LI>');
// document.writeln('        <LI><img src="/templets/default/images/ewm.gif" width="100" ></LI>');
// document.writeln('      </UL>');
// document.writeln('      <UL>');
// document.writeln('        <LI>');
// document.writeln('          <H3 class=titDh>服务热线</H3>');
// document.writeln('        </LI>');
// document.writeln('        <LI><SPAN class=icoTl>15869003718</SPAN> </LI>');
// document.writeln('      </UL>');
...
var urlroot = "http://www.hzjy-kj.com/";
var tOut = -1;
var drag = false;
var g_safeNode = null;
lastScrollY = 0;
...
$(function(){
$(".cn ul li:last-child").addClass("bot");
})